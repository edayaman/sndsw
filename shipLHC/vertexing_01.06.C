...
void checkpatterns(){
    ...
    TString filePath = "/eos/experiment/sndlhc/emulsionData/2022/emureco_Napoli/RUN0/b000031/"; // Specify the desired path here

    TFile* setfile = TFile::Open(Form("%s/b%06d.0.0.0.set.root", filePath.Data(), BRICKID));


    //TFile *setfile = TFile::Open(Form("b%06d.0.0.0.set.root",BRICKID));   eski hali
